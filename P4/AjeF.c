...
void imprimir_tablero(char (*tablero)[TAM])
{
    printf("\n");
    for (int i = 0; i < TAM; i++) {
        for (int j = 0; j < TAM; j++) {
...
void movimientos_reina(Coordenada coordenada, char (*tablero)[TAM])
{
...
void movimientos_rey(Coordenada coordenada, char (*tablero)[TAM])
{
    int fila = coordenada.fila;
    int columna = coordenada.columna;
...
void movimientos_torre(Coordenada coordenada, char (*tablero)[TAM])
{
    int fila = coordenada.fila;
    int columna = coordenada.columna;
...
void movimientos_alfil(Coordenada coordenada, char (*tablero)[TAM])
{
    int fila = coordenada.fila;
    int columna = coordenada.columna;
...
void movimientos_caballo(Coordenada coordenada, char (*tablero)[TAM])
{
    int fila = coordenada.fila;
    int columna = coordenada.columna;
